    ...
    def wrap_tool_call(self, ctx, call, name, args):
        ...
        while BLOCK_START in content:
            ...
            if end_idx != -1:
                ...
                # No closing marker (truncated fetch) — strip from start to end
                content = content[:start_idx] + PLACEHOLDER
        from arena.tools import ToolResult as TR
        return TR(ok=result.ok, content=content, error=result.error)
