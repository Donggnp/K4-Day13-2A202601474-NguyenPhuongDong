...
class CitationChecker(Middleware):
    ...
    def after_agent(self, ctx, report):
        ...
        for claim in claims:
            ...
            # Check if citation is already correct (text matches a LINE in cited doc)
            ...
            # Text doesn't match a line in the cited doc — find the real source
            # Only consider docs whose body was fully observed (fetched cleanly)
        ...
        # Update citations to match re-attributed claims
        cites = []
        for c in claims:
            did = c.get("doc_id", "")
